...
export class PaypalButton extends React.Component {
	render() {
		...
		let total = 10; // this is the total amount (based on currency) to charge
		// Document on Paypal's currency code: https://developer.paypal.com/docs/classic/api/currency_codes/

		const client = {
			sandbox: "AfovkgOJ9nDHSNloqkrzKEniWueDWumU0p3FeZqMJcQIk3Uf55P9LoHPbZ8bHRiFgkftBZE-c5jdRsnI",
